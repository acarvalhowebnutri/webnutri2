...
public class HistoricoConsumidosPacienteFragment extends DialogFragment
    ...
    public void onDateSet(DatePicker view, int yy, int mm, int dd) {
        ...
        ListaNutricionistaHistoricoConsumidosPacienteFragmentFirebase mainFragment = new ListaNutricionistaHistoricoConsumidosPacienteFragmentFirebase();


// Passando um link
        Bundle b = getArguments();
        String idpaciente = b.getString("idpaciente");
