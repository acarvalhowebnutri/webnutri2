...
public class NutricionistaDAOold {
    ...
    */
    public void remove(Usuario usuario) {
        ...
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        db.delete(Constantes.TB_USUARIO, " _id=?", new String[]{usuario.getId().toString()});
        db.close();
    ...
    public List<Usuario> listaTodosPacientes() {
        List<Usuario> listapaciente = new ArrayList<Usuario>();
        dbHelper.openDatabase();
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        Cursor c = db.query(Constantes.TB_USUARIO, null, null, null, null, null, "nome ASC");
        try {
            while (c.moveToNext()) {
    ...
    public List<Usuario> listaPaciente(String CRN) {
        List<Usuario> listapaciente = new ArrayList<Usuario>();
        dbHelper.openDatabase();
        SQLiteDatabase db = dbHelper.getReadableDatabase();
